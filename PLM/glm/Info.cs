    ...
    public class Info
	{
		...
		public string DTOrig
		{
			get 
			{
                ...
                try
                {
                    ...
                    rc = ExifDTToDateTime(tmpStr);
                    retval = rc.ToShortDateString();
                }
                catch
                {
                    retval = "";
		...
		public string  DTDigitized
		{
			get 
			{
                ...
                try
                {
                    tmpStr = (string)PropertyTag.getValue(_image.GetPropertyItem((int)PropertyTagId.ExifDTDigitized));
                    rc = ExifDTToDateTime(tmpStr);
                    tmpStr = rc.ToShortDateString();
                }
                catch  {
                    tmpStr = "";
                }	

            ...
            foreach (string fileName in Request.Files)
            {
                ...
                else
                {
                    if (file != null && file.ContentLength > 0)
                    {
                        ...
                        // Checks the filename of the file the user submitted with the filename
                        // the program generates to save and makes sure they aren't the same
                        // If they are, duplicate files would exist. This process negates that
                        // and saves the image with the correct name generated by the naming convention
